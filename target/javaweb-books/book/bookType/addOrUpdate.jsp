        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="signupForm" action="/book/bookTypeServlet?action=saveOrUpdate" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-3">
                                ...
                                <a class="btn btn-default" href="/book/bookTypeServlet?action=list">取消</a>
                            </div>
                        </div>
                    </form>
                </div>
